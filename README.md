...
50 ).
Due date: Sept 30, 2020. Time: 23:59 Hrs. (Hard Deadline)
...
Your task is to design your a simple shell that can handle five, internal commands – ‘cd’, ‘echo’, ‘history’, ‘pwd’ and ‘exit’. These commands
...
2• Correct handling of commands (two options per command, as described
earlier) – 20 points.
